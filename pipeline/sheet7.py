...
A("4. **生物学单元 ≤ 12 条链。** 上百条链的生物学单元里,「正确答案」不是学生会提交的那几条链。")
A("")
A("### 逐个核对过的四件事")
A("")
...
A(f"据此:**膜蛋白 {_zm}/{_tm} 题、异源复合体 {_zh}/{_th} 题选用训练截止前查不到同源体"
  f"的结构**,是真正的从头预测测试。")
